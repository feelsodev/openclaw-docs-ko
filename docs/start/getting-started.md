...
게이트웨이 호스트(OpenClaw 게이트웨이 서비스를 실행하는 머신).
...
::: details Run the Gateway in the foreground
...
## 더 깊이 들어가 보세요
  ...
  - [**Onboarding Wizard (details)**](/start/wizard) - 전체 CLI 마법사 참조 및 고급 옵션.

  - [**macOS app onboarding**](/start/onboarding) - macOS 앱의 첫 번째 실행 흐름입니다.
