...
![기업용 앱 만들기](https://docs.openclaw.ai/images/feishu-step2-create-app.png)
...
![자격 증명 받기](https://docs.openclaw.ai/images/feishu-step3-credentials.png)
...
![권한 구성](https://docs.openclaw.ai/images/feishu-step4-permissions.png)
...
![봇 기능 활성화](https://docs.openclaw.ai/images/feishu-step5-bot-capability.png)
...
![이벤트 구독 구성](https://docs.openclaw.ai/images/feishu-step6-event-subscription.png)
