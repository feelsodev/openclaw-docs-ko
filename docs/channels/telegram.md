...
상태: grammY를 통해 봇 DM + 그룹에 대한 프로덕션 준비가 완료되었습니다. 긴 폴링이 기본 모드입니다. 웹훅 모드는 선택 사항입니다.
  ...
  - [**Pairing**](/channels/pairing) - 텔레그램의 기본 DM 정책은 페어링입니다.

  - [**Channel troubleshooting**](/channels/troubleshooting) - 교차 채널 진단 및 수리 플레이북.

  - [**Gateway configuration**](/gateway/configuration) - 전체 채널 구성 패턴 및 예시
...
::: details Privacy mode and group visibility
...
::: details Helpful BotFather toggles
...
::: details Draft streaming in Telegram DMs
...
::: details Formatting and HTML fallback
...
::: details Native commands and custom commands
...
::: details Telegram message actions for agents and automation
...
::: details Forum topics and thread behavior
  포럼 슈퍼그룹:
...
::: details Audio, video, and stickers
  ### 오디오 메시지
...
::: details Config writes from Telegram events and commands
...
::: details Long polling vs webhook
  기본값: 긴 폴링.
...
::: details Limits, retry, and CLI targets
...
::: details Bot does not respond to non mention group messages
...
::: details Bot not seeing group messages at all
...
::: details Commands work partially or not at all
...
::: details Polling or network instability
