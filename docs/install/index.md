...
## 기타 설치 방법
  ...
  - [**Docker**](/install/docker) - 컨테이너화된 또는 헤드리스 배포.

  - [**Nix**](/install/nix) - Nix를 통한 선언적 설치.

  - [**Ansible**](/install/ansible) - 자동화된 차량 프로비저닝.

  - [**Bun**](/install/bun) - Bun 런타임을 통한 CLI 전용 사용.
...
::: details PATH diagnosis and fix
  빠른 진단:
...
## 업데이트/제거
  ...
  - [**Updating**](/install/updating) - OpenClaw를 최신 상태로 유지하세요.

  - [**Migrating**](/install/migrating) - 새 기계로 이동합니다.

  - [**Uninstall**](/install/uninstall) - OpenClaw를 완전히 제거하십시오.
